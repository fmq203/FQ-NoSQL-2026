...
class StructuredLoggingMiddleware(BaseHTTPMiddleware):
    def __init__(self, app, logger_name: str = "reservas-service"):
        super().__init__(app)
    ...
    def _log_request(self, request, correlation_id, trace_id, span_id):
        self.logger.info(
            "Request entrante",
            extra={
    ...
    def _log_response(self, request, response, correlation_id, trace_id, span_id, duration_ms: float):
    ...
    def _log_error(self, request, error, correlation_id, trace_id, span_id, duration_ms: float):
        self.logger.error(
